  ...
  <div class="cover-bg p-3 p-lg-4 text-white">
    <div class="row">
      <div class="col-lg-4 col-md-5">
        <div class="avatar hover-effect bg-white shadow-sm p-1"><img src="../../images/contact-data/<?php print_r($value['image']);?>" width="200" height="200"/></div>
      </div>
      <div class="col-lg-8 col-md-7 text-center text-md-start">
        <h2 class="h1 mt-2" data-aos="fade-left" data-aos-delay="0"><?php print_r($value['firstname']); print_r(" "); print_r($value['lastname']);?></h2>
        <p data-aos="fade-left" data-aos-delay="100"><?php print_r($value['profession']);?></p>
        <div class="d-print-none" data-aos="fade-left" data-aos-delay="200"><a class="btn btn-light text-dark shadow-sm mt-1 me-1" href="" onclick="myprint()" target="_blank">Download CV</a><a class="btn btn-success shadow-sm mt-1" href="" onclick="myprint()">Hire Me</a></div>
...
?>
      <div class="col-md-5 offset-md-1">
        <div class="row mt-2">
          ...
          <div class="col-sm-8">
            <div class="pb-1 text-secondary"><?php print_r($value['email']);?></div>
          </div>
          <div class="col-sm-4">
...
?>
      <div class="timeline-card timeline-card-primary card shadow-sm">
        <div class="card-body">
          ...
          <div class="text-muted text-small mb-2"><?php print_r($valuee1['sdate']);?>   - <?php print_r($valuee1['edate']);?></div>
          <div class="text-text"><?php print_r($valuee['text']);?>.</div>
        </div>
      </div>
<?php
}
...
?>
      <div class="timeline-card timeline-card-primary card shadow-sm">
        <div class="card-body">
          ...
          <div class="text-muted text-small mb-2"><?php print_r($valuee2['sdate']);?>   - <?php print_r($valuee2['edate']);?></div>
...
?>
  ...
  <div class="contant-section px-3 px-lg-4 pb-4" id="contact">
    ...
    <footer class="pt-4 pb-4 text-muted text-center d-print-none">
      <div class="container">
        <div class="my-3">
          <div class="h4"><?php print_r($value['firstname']); print_r(" "); print_r($value['lastname']);?></div>

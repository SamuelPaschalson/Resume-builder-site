...
<html>
  ...
  <body>
    ...
    <header class="">
      <div class="heading-tag fixed-top">
        <div class="heading-text">
          <form class="" action="code" method="post" accept-charset="utf-8">
            <input type="hidden" name="id" id="id" value="<?php echo ($_SESSION['id']); ?>" />
          <button name="work-d3" class="btn ri-arrow-left-line" type="submit"></button>
          </form>
      ...
      <div class="contact-info-text">
        ...
        <div class="contact-info-body work">
          ...
          <div class="buttons">
            ...
            <div class="nav-btn">
              <button id="submit" name="workh4" class="btn btn-outline-warning" type="submit">NEXT:ADD WORK DETAILS</button>
            </div>
          </div>
          </form>
        </div>
    ...
    <section class="section-info-small">
      <div class="contact-info-text-small">
        ...
        <div class="contact-info-bod-small">
          ...
          <div class="buttons">
            <div class="nav-btn">
              <button name="workh4" class="btn btn-outline-warning" type="submit">NEXT:ADD WORK DETAILS</button>
            </div>
          </div>
          </form>
        </div>

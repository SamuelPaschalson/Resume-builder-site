    ...
    <header class="">
      <div class="heading-tag">
        <div class="heading-text">
          ...
          <button name="work-d" class="btn ri-arrow-left-line" type="submit"></button>
          </form>
    ...
    <section class="section-info">
      <div class="contact-info-text">
        <div class="info-text">
          ...
          <p>The second company you have worked for, and its details.</p>
        </div>
        <div class="contact-info-body work">
          <form method="post" action="code.php" >
            ...
            <div id="dynamic_field">
              ...
              <div class="col-sm-6 mb-3 mb-sm-0">
                ...
                <input type="month" name="sdate" id="" class="form-control form-control-user" placeholder="e.g. 06-02-2020" value="" />
              </div>
              <div class="col-sm-6">
                <label class="form-control-label" for="">End Date</label>
                <input type="month" name="edate" id="" class="form-control" placeholder="e.g. 08-07-2022" value="" />
              </div>
            </div>
              <div class="form-group">
                      <div class="small">
          ...
          <div class="buttons">
            ...
            <div class="nav-btn">
              <button id="submit" name="workh1" class="btn btn-outline-warning" type="submit">NEXT:ADD WORK DETAILS</button>
            </div>
          </div>
          </form>
    ...
    <section class="section-info-small">
      <div class="contact-info-text-small">
        ...
        <div class="contact-info-bod-small">
          ...
          <div class="buttons">
            <div class="nav-btn">
              <button name="workh1" class="btn btn-outline-warning" type="submit">NEXT:ADD WORK DETAILS</button>
            </div>
          </div>
          </form>
        </div>

...
<body class="light-version">
    ...
    <section class="section-info">
        <div class="contact-info-text">
            <div class="info-text">
                <h3 class="h4">Do you have another Education?</h3>
                <p>We suggest you add all your education.</p>
            </div>
            <div class="contact-info-body">
                <form class="" action="code.php" method="post">
                    ...
                    <div class="form-group">
                        <label class="form-control-label" for="">Add New Education</label>
                        <select name="check11" class="form-control form-select" aria-label="Default select example">
                    ...
                    <div class="buttons">
                        ...
                        <div class="nav-btn">
                            <button name="check1" class="btn btn-outline-warning" type="submit">NEXT: DETAILS</button>
                        </div>
                    </div>
                </form>
            </div>

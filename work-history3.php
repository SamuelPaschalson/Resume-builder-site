    ...
    <header class="">
      <div class="heading-tag">
        <div class="heading-text">
          ...
          <button name="work-d2" class="btn ri-arrow-left-line" type="submit"></button>
          </form>
      ...
      <div class="contact-info-text">
        ...
        <div class="contact-info-body work">
          ...
          <div class="buttons">
            ...
            <div class="nav-btn">
              <button id="submit" name="workh3" class="btn btn-outline-warning" type="submit">NEXT:ADD WORK DETAILS</button>
            </div>
          </div>
          </form>
        </div>
        ...
        <div class="contact-info-bod-small">
          <form class="" action="code.php" method="post">
            ...
            <div class="form-group row">
              <div class="col-sm-6 mb-3 mb-sm-0">
                <label class="form-control-label" for="">Start Date</label>
                <input type="date" name="sdate" id="" class="form-control form-control-user" placeholder="e.g. USA" value="" />
              </div>
              <div class="col-sm-6">
                <label class="form-control-label" for="">End Date</label>
                <input type="date" name="edate" id="" class="form-control" placeholder="e.g. 1234" value="" />
              </div>
            </div>
               <div class="form-group">
          ...
          <div class="social-text">
            <div class="social" id="social">
              ...
              <h5 class="h6" onclick="">Add More Work</h5>
            </div>
          </div>
          <div class="buttons">
            <div class="nav-btn">
              <button name="workh3" class="btn btn-outline-warning" type="submit">NEXT:ADD WORK DETAILS</button>
            </div>
          </div>
          </form>
        </div>

    ...
    <header class="">
      <div class="heading-tag">
        <div class="heading-text">
          ...
          <button name="edu-2" class="btn ri-arrow-left-line" type="submit"></button>
          </form>
    ...
    <section class="section-info">
      <div class="contact-info-text">
        ...
        <div class="contact-info-body">
          ...
          <div class="buttons">
            <div class="nav-btns">
              <a class="btn btn-outline-primary" href="education2.php">BACK</a>
            </div>
            <div class="nav-btn">
              <button name="edu3" class="btn btn-outline-warning" type="submit">NEXT:EDUCATION</button>
            </div>
          </div>
          </form>

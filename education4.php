    ...
    <header class="">
      <div class="heading-tag">
        <div class="heading-text">
          ...
          <button name="edu-3" class="btn ri-arrow-left-line" type="submit"></button>
          </form>
    ...
    <section class="section-info">
      <div class="contact-info-text">
        ...
        <div class="contact-info-body">
          ...
          <div class="buttons">
            <div class="nav-btns">
              <a class="btn btn-outline-primary" href="work-details.html">BACK</a>
            </div>
            <div class="nav-btn">
              <button name="edu4" class="btn btn-outline-warning" type="submit">NEXT: CERTIFICATION</button>
            </div>
          </div>
          </form>
